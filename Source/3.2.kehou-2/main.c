...
static char * argv_rc[] = { "/sh", NULL };
static char * envp_rc[] = { "HOME=/", "PATH=.", NULL };

static char * argv[] = { "-/sh",NULL };
static char * envp[] = { "HOME=/", "PATH=.", NULL };
