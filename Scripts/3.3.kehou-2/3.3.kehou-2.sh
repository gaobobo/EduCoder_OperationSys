...
case $DownloadSite in
    Gitee)
        ...
        wget -O /tmp/3.3.kehou-2/1.log https://gitee.com/coconut_floss/EduCoder_OperationSys/raw/main/Source/3.3.kehou-1/sched.c
        ;;
    Github)
        wget -O /tmp/3.3.kehou-2/1.log https://raw.githubusercontent.com/gaobobo/EduCoder_OperationSys/main/Source/3.3.kehou-1/1.log
        wget -O /tmp/3.3.kehou-2/1.log https://raw.githubusercontent.com/gaobobo/EduCoder_OperationSys/main/Source/3.3.kehou-1/sched.c
        ;;
    *)
